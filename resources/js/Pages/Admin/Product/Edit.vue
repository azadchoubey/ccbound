...
<template>
  <AdminLayout title="Edit">
    <FormSection @submitted="updateProfileInformation" class="mx-[5rem] m-[2rem]">
      ...
      <template #form>
        ...
        <div class="col-span-6 sm:col-span-4">
          ...
          <TextInput id="number" type="text" value="1234567890" class="mt-1 block w-full" autocomplete="name" />
          <InputError :message="form.errors.name" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
          ...
          <TextInput id="address" type="text" value="521 " class="mt-1 block w-full" autocomplete="name" />
          <InputError :message="form.errors.name" class="mt-2" />
        </div>
      </template>
