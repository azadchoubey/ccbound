        ...
        <form>
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <TextInput id="price" type="number" class="mt-1 block w-full" required autofocus />
              <!-- <InputError class="mt-2" :message="form.errors.email" /> -->
            </div>
            <div>
              <InputLabel for="products" value="Products" />
              <TextInput id="products" type="number" class="mt-1 block w-full" required autofocus />
              <!-- <InputError class="mt-2" :message="form.errors.email" /> -->
            </div>
          </div>
          <PrimaryButton class="mt-2"> Add Pack </PrimaryButton>
        </form>
      </div>
    </div>
  </AdminLayout>
