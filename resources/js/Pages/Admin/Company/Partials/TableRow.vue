...
<template>
  ...
  <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
    ...
    <td class="border-t">
      <p class="flex items-center px-6 py-4 font-semibold">rakesh@gmail.com</p>
    </td>
    <td class="border-t">
      <p class="flex items-center px-6 py-4 font-semibold">3125649870</p>
    </td>
    <td class="border-t relative flex flex-col justify-center items-center pt-2.5">
      ...
      >
        <Link
          :href="route('admin.company.edit', { id: 1 })"
